<?php
	...
	# php -S ip_adresi:port #PHP SESSION AÇMA 
	Böyle yapıldığında php ile kendi ipmizin belirttiğimiz port numarasından bir dinleme yapıyoruz.
	...
	Böylelikle oturum çalma işlemi vs. gibi işlemler gerçekleştirebiliyoruz.
        */
?>
